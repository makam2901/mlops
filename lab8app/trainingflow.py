...
class RandomForestTrainFlow(FlowSpec):
    ...
    def train_all(self):
        ...
        mlflow.set_experiment("mlflow-fastapi")
        ...
        param_dist = {
            ...
            'max_features': list(range(1, n_features+1))  # Integer values from 1 to n_features
        }
    ...
    def register_best(self):
        ...
        with mlflow.start_run(run_id=self.best_run_id):
            mlflow.sklearn.log_model(
                ...
                artifact_path="model",
                registered_model_name="best-rf-model-fastapi"
            )
